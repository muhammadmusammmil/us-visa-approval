import os
from src.us_visa_approval.constant import *
...
trainingPipleLineConfig: TrainingPipelineConfig = TrainingPipelineConfig()

@dataclass
class DataIngestionConfig:
    data_ingestion_dir: str = os.path.join(trainingPipleLineConfig.artifact_dir, DATA_INGESTION_DIR_NAME)
...
class DataValidationConfig:
    data_validation_dir: str = os.path.join(trainingPipleLineConfig.artifact_dir, DATA_VALIDATION_DIR_NAME)
...
class DataTransformationConfig:
    data_transformation_dir: str = os.path.join(trainingPipleLineConfig.artifact_dir, DATA_TRANSFORMATION_DIR_NAME)        
...
class ModelTrainingConfig:
    model_trainer_dir: str = os.path.join(trainingPipleLineConfig.artifact_dir, MODEL_TRAINER_DIR_NAME)
